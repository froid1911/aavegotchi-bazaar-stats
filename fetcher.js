...
const graphStaking = apollo.createApolloFetch({
  uri: "https://static.138.182.90.157.clients.your-server.de/subgraphs/name/aavegotchi-staking-subgraph-43000",
});
...
export default async (url) => {
  ...
  trades = {
    labels: bazaarStats.map((e) =>
      new Date(parseInt(e.timestamp) * 1000).toDateString()
    ),
    datasets: [
      {
  ...
  frens = {
    labels: staking.map((e) =>
      new Date(parseInt(e.id.split("-")[1]) * 1000).toDateString()
    ),
    datasets: [
      {
      ...
      },
      {
        ...
        pointHitRadius: 10,
        data: staking.map((e) =>
          parseInt(e.totalBurnedFrensForTickets.slice(0, -18))
        ),
      },
      {
  ...
  ticketsGodlike = {
    ...
    datasets: [
      ...
      },
      {
        ...
        pointHitRadius: 10,
        data: staking.map((e) =>
          parseInt(e.totalBurnedGodlikeTicketsForRaffles)
        ),
      },
      {
  ...
  ticketsMythical = {
    ...
    datasets: [
      ...
      },
      {
        ...
        pointHitRadius: 10,
        data: staking.map((e) =>
          parseInt(e.totalBurnedMythicalTicketsForRaffles)
        ),
      },
      {
  ...
  ticketsUncommon = {
    ...
    datasets: [
      ...
      },
      {
        ...
        pointHitRadius: 10,
        data: staking.map((e) =>
          parseInt(e.totalBurnedUncommonTicketsForRaffles)
        ),
      },
      {
  ...
  ticketsCommon = {
    ...
    datasets: [
      ...
      },
      {
        ...
        pointHitRadius: 10,
        data: staking.map((e) =>
          parseInt(e.totalBurnedCommonTicketsForRaffles)
        ),
      },
      {
